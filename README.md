...
Afterwards, tasks were divided in ilclaass, taking into account tkunugi's learning goals and growth.

## Reflection

tkunugi was able to learn the structure and conceptual ideas by implementing a state machine.
